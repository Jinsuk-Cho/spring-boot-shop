...
class ItemRepositoryTest {
    ...
    public void findByItemNmTest() {
        this.createItemTest();
        List<Item> itemList = itemRepository.findByItemNm("상품 No.1");
    ...
    public void findByPriceLessThanOrderByPriceDesc() {
        this.createItemList();
        List<Item> itemList = itemRepository.findByPriceLessThanOrderByPriceDesc(10003);
        for (Item item : itemList) {
            System.out.println(item.toString());
        }
    }
    ...
    @Test
    @DisplayName("native Query 속성을 이용한 상품조회 테스트")
